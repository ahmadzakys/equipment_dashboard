...
layout = html.Div([
                ...
                dbc.Row([
                    dbc.Col([
                        dbc.Row([
                            dbc.Col([dcc.Graph(id="hou_c1_natuna")], xs=4),
                            dbc.Col([dcc.Graph(id="crane_1_natuna")], xs=8)
                        ]),
                    ], xs=5),

                    dbc.Col([
                        dbc.Row([
                            dcc.Graph(id="toh_natuna")
                        ]),

                        html.Br(),

                        dbc.Row([
                            dcc.Graph(id="goh_natuna")
                        ]),

                        html.Br(),

                        dbc.Row([
                            dcc.Graph(id="au_natuna")
                        ]),
                    ], xs=4),
                    ...
                    dbc.Col([
                        dbc.CardGroup([
                            ...
                            dbc.Card(
                                html.Div(id="ConMakerShape_natuna", style={
                                                                        "color": "white",
                                                                        "textAlign": "center",
                                                                        "fontSize": 25,
                                                                        "margin": "auto",
                                                                    }),
                                id="ConMakerCol_natuna",
                        ...
                        dbc.CardGroup([
                            ...
                            dbc.Card(
                                html.Div(id="CraneMakerShape_natuna", style={
                                                                        "color": "white",
                                                                        "textAlign": "center",
                                                                        "fontSize": 25,
                                                                        "margin": "auto",
                                                                    }),
                                id="CraneMakerCol_natuna",
                                color="light", outline=True, style={"height": 55, "margin-bottom": "5px", "maxWidth": 75}
                            ),
                        ],),
                        ...
                        dbc.CardGroup([
                            ...
                            dbc.Card(
                                html.Div(id="EngMakerShape_natuna", style={
                                                                        "color": "white",
                                                                        "textAlign": "center",
                                                                        "fontSize": 25,
                                                                        "margin": "auto",
                                                                    }),
                                id="EngMakerCol_natuna",
                                color="light", outline=True, style={"height": 55, "margin-bottom": "5px", "maxWidth": 75}
                            ),
                        ],),
                        ...
                        dbc.CardGroup([
                            ...
                            dbc.Card(
                                html.Div(id="OthersShape_natuna", style={
                                                                        "color": "white",
                                                                        "textAlign": "center",
                                                                        "fontSize": 25,
                                                                        "margin": "auto",
                        ...
                        dbc.CardGroup([
                            dbc.Card(
                                dbc.CardBody(
                                    [
                                        html.P(id="NextDockingDate_natuna",
                                                style={'textAlign': 'left', 
                                                    'fontSize': 15, 
                                                    'background-color':'white',
                                                    'color':'#2a3f5f',
                        ...
                        dbc.CardGroup([
                            ...
                            dbc.Card(
                                html.Div(id="ConSpareShape_natuna", style={
                                                                        "color": "white",
                                                                        "textAlign": "center",
                                                                        "fontSize": 25,
                                                                        "margin": "auto",
                                                                    }),
                                id="ConSpareCol_natuna",
                                color="light", outline=True, style={"height": 55, "margin-bottom": "5px", "maxWidth": 75}
                            ),
                        ],),
                        ...
                        dbc.CardGroup([
                            ...
                            dbc.Card(
                                html.Div(id="CraneSpareShape_natuna", style={
                                                                        "color": "white",
                                                                        "textAlign": "center",
                                                                        "fontSize": 25,
                                                                        "margin": "auto",
                                                                    }),
                                id="CraneSpareCol_natuna",
                                color="light", outline=True, style={"height": 55, "margin-bottom": "5px", "maxWidth": 75}
                            ),
                        ],),
                        ...
                        dbc.Row([
                            ...
                            dbc.CardGroup([
                                ...
                                dbc.Card(
                                    html.Div(id="CraneShape_natuna", style={
                                                                            "color": "white",
                                                                            "textAlign": "center",
                                                                            "fontSize": 17,
                                                                            "margin": "auto",
                            ...
                            dbc.Col([
                                dbc.CardGroup([
                                    ...
                                    dbc.Card(
                                        html.Div(id="ConShape_natuna", style={
                                                                                "color": "white",
                                                                                "textAlign": "center",
                                                                                "fontSize": 17,
                                                                                "margin": "auto",
                            ...
                            dbc.Col([
                                dbc.CardGroup([
                                    ...
                                    dbc.Card(
                                        html.Div(id="EngShape_natuna", style={
                                                                                "color": "white",
                                                                                "textAlign": "center",
                                                                                "fontSize": 17,
                                                                                "margin": "auto",
...
@callback(
    [Output('hou_c1_natuna', 'figure'),
     Output('toh_natuna', 'figure'),
     Output('goh_natuna', 'figure'),
     Output('crane_1_natuna', 'figure'),
     Output('au_natuna', 'figure'),

     Output('ConMakerShape_natuna', 'className'),
     Output('ConMakerCol_natuna', 'className'),
     Output('CraneMakerShape_natuna', 'className'),
     Output('CraneMakerCol_natuna', 'className'),
     Output('EngMakerShape_natuna', 'className'),
     Output('EngMakerCol_natuna', 'className'),
     Output('OthersShape_natuna', 'className'),
     Output('OthersCol_natuna', 'className'),
     Output('NextDockingDate_natuna', 'children'),
     Output('NextDockingCol_natuna', 'className'),
     Output('ConSpareShape_natuna', 'className'),
     Output('ConSpareCol_natuna', 'className'),
     Output('CraneSpareShape_natuna', 'className'),
     Output('CraneSpareCol_natuna', 'className'),
     Output('CraneShape_natuna', 'className'),
     Output('CraneCol_natuna', 'className'),
     Output('ConShape_natuna', 'className'),
     Output('ConCol_natuna', 'className'),
     Output('EngShape_natuna', 'className'),
     Output('EngCol_natuna', 'className'),
     ],
    Input('store', 'data')
)
def update_charts(data):
    ...
    return hou_c1, toh, goh, crane_1, au,\
