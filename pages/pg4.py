...
dash.register_page(__name__, name='Dewata')
...
layout = html.Div([
                ## --ROW1--
                html.Br(),
                html.P(children=[html.Strong('Bulk Dewata')],
                       style={'textAlign': 'center', 'fontSize': 27, 'background-color':'white','color':'#2a3f5f','font-family':'Verdana'}),

                dbc.Row([
                    dbc.Col([
                        dbc.Row([
                            dbc.Col([dcc.Graph(id="hou_c1_dewata")], xs=4),
                            dbc.Col([dcc.Graph(id="crane_1_dewata")], xs=8)
                        ]),

                        html.Br(),

                        dbc.Row([
                            dbc.Col([dcc.Graph(id="hou_c2_dewata")], xs=4),
                            dbc.Col([dcc.Graph(id="crane_2_dewata")], xs=8)
                        ]),

                        html.Br(),

                        dbc.Row([
                            dcc.Graph(id="cbu_dewata")
                        ])
                    ], xs=5),

                    dbc.Col([
                        dbc.Row([
                            dcc.Graph(id="toh_dewata")
                        ]),

                        html.Br(),

                        dbc.Row([
                            dcc.Graph(id="goh_dewata")
                        ]),

                        html.Br(),

                        dbc.Row([
                            dcc.Graph(id="au_dewata")
                        ]),
                    ], xs=4),
                    ...
                    dbc.Col([
                        dbc.CardGroup([
                            ...
                            dbc.Card(
                                html.Div(id="ConMakerShape_dewata", style={
                                                                        "color": "white",
                                                                        "textAlign": "center",
                                                                        "fontSize": 25,
                                                                        "margin": "auto",
                                                                    }),
                                id="ConMakerCol_dewata",
                        ...
                        dbc.CardGroup([
                            ...
                            dbc.Card(
                                html.Div(id="CraneMakerShape_dewata", style={
                                                                        "color": "white",
                                                                        "textAlign": "center",
                                                                        "fontSize": 25,
                                                                        "margin": "auto",
                                                                    }),
                                id="CraneMakerCol_dewata",
                                color="light", outline=True, style={"height": 55, "margin-bottom": "5px", "maxWidth": 75}
                            ),
                        ],),
                        ...
                        dbc.CardGroup([
                            ...
                            dbc.Card(
                                html.Div(id="EngMakerShape_dewata", style={
                                                                        "color": "white",
                                                                        "textAlign": "center",
                                                                        "fontSize": 25,
                                                                        "margin": "auto",
                                                                    }),
                                id="EngMakerCol_dewata",
                                color="light", outline=True, style={"height": 55, "margin-bottom": "5px", "maxWidth": 75}
                            ),
                        ],),
                        ...
                        dbc.CardGroup([
                            ...
                            dbc.Card(
                                html.Div(id="OthersShape_dewata", style={
                                                                        "color": "white",
                                                                        "textAlign": "center",
                                                                        "fontSize": 25,
                                                                        "margin": "auto",
                        ...
                        dbc.CardGroup([
                            dbc.Card(
                                dbc.CardBody(
                                    [
                                        html.P(id="NextDockingDate_dewata",
                                                style={'textAlign': 'left', 
                                                    'fontSize': 15, 
                                                    'background-color':'white',
                                                    'color':'#2a3f5f',
                        ...
                        dbc.CardGroup([
                            ...
                            dbc.Card(
                                html.Div(id="ConSpareShape_dewata", style={
                                                                        "color": "white",
                                                                        "textAlign": "center",
                                                                        "fontSize": 25,
                                                                        "margin": "auto",
                                                                    }),
                                id="ConSpareCol_dewata",
                                color="light", outline=True, style={"height": 55, "margin-bottom": "5px", "maxWidth": 75}
                            ),
                        ],),
                        ...
                        dbc.CardGroup([
                            ...
                            dbc.Card(
                                html.Div(id="CraneSpareShape_dewata", style={
                                                                        "color": "white",
                                                                        "textAlign": "center",
                                                                        "fontSize": 25,
                                                                        "margin": "auto",
                                                                    }),
                                id="CraneSpareCol_dewata",
                                color="light", outline=True, style={"height": 55, "margin-bottom": "5px", "maxWidth": 75}
                            ),
                        ],),
                        ...
                        dbc.Row([
                            ...
                            dbc.CardGroup([
                                ...
                                dbc.Card(
                                    html.Div(id="CraneShape_dewata", style={
                                                                            "color": "white",
                                                                            "textAlign": "center",
                                                                            "fontSize": 17,
                                                                            "margin": "auto",
                            ...
                            dbc.Col([
                                dbc.CardGroup([
                                    ...
                                    dbc.Card(
                                        html.Div(id="ConShape_dewata", style={
                                                                                "color": "white",
                                                                                "textAlign": "center",
                                                                                "fontSize": 17,
                                                                                "margin": "auto",
                            ...
                            dbc.Col([
                                dbc.CardGroup([
                                    ...
                                    dbc.Card(
                                        html.Div(id="EngShape_dewata", style={
                                                                                "color": "white",
                                                                                "textAlign": "center",
                                                                                "fontSize": 17,
                                                                                "margin": "auto",
                        ...
                        dbc.Row([
                            dbc.Col([
                                dbc.Card([
                                    dbc.CardBody([dcc.Graph(id="cs_crane_dewata")])
                                ], color="light", outline=True, style={"height": 160, "margin-bottom": "5px"}),
                            ], xs=4, className="g-0 d-flex align-items-center"),

                            dbc.Col([
                                dbc.Card([
                                    dbc.CardBody([dcc.Graph(id="cs_conveyor_dewata")])
                                ], color="light", outline=True, style={"height": 160, "margin-bottom": "5px"}),
                            ], xs=4, className="g-0 d-flex align-items-center"),

                            dbc.Col([
                                dbc.Card([
                                    dbc.CardBody([dcc.Graph(id="cs_engine_dewata")])
                                ], color="light", outline=True, style={"height": 160, "margin-bottom": "5px"}),
                            ], xs=4, className="g-0 d-flex align-items-center")
                        ], className="g-0 d-flex align-items-center"),
                    ], xs=3)
...
@callback(
    [Output('hou_c1_dewata', 'figure'),
     Output('hou_c2_dewata', 'figure'),
     Output('toh_dewata', 'figure'),
     Output('goh_dewata', 'figure'),
     Output('crane_1_dewata', 'figure'),
     Output('crane_2_dewata', 'figure'),
     Output('cbu_dewata', 'figure'),
     Output('au_dewata', 'figure'),

     Output('ConMakerShape_dewata', 'className'),
     Output('ConMakerCol_dewata', 'className'),
     Output('CraneMakerShape_dewata', 'className'),
     Output('CraneMakerCol_dewata', 'className'),
     Output('EngMakerShape_dewata', 'className'),
     Output('EngMakerCol_dewata', 'className'),
     Output('OthersShape_dewata', 'className'),
     Output('OthersCol_dewata', 'className'),
     Output('NextDockingDate_dewata', 'children'),
     Output('NextDockingCol_dewata', 'className'),
     Output('ConSpareShape_dewata', 'className'),
     Output('ConSpareCol_dewata', 'className'),
     Output('CraneSpareShape_dewata', 'className'),
     Output('CraneSpareCol_dewata', 'className'),
     Output('CraneShape_dewata', 'className'),
     Output('CraneCol_dewata', 'className'),
     Output('ConShape_dewata', 'className'),
     Output('ConCol_dewata', 'className'),
     Output('EngShape_dewata', 'className'),
     Output('EngCol_dewata', 'className'),

     Output('cs_crane_dewata', 'figure'),
     Output('cs_conveyor_dewata', 'figure'),
     Output('cs_engine_dewata', 'figure'),
     ],
    Input('store', 'data')
)
