...
dash.register_page(__name__, path='/', name='Sumatra') # '/' is home page
...
layout = html.Div([
                ## --ROW1--
                html.Br(),
                html.P(children=[html.Strong('Bulk Sumatra')],
                       style={'textAlign': 'center', 'fontSize': 27, 'background-color':'white','color':'#2a3f5f','font-family':'Verdana'}),

                dbc.Row([
                    dbc.Col([
                        dbc.Row([
                            dbc.Col([dcc.Graph(id="hou_c1_sumatra")], xs=4),
                            dbc.Col([dcc.Graph(id="crane_1_sumatra")], xs=8)
                        ]),

                        html.Br(),

                        dbc.Row([
                            dbc.Col([dcc.Graph(id="hou_c2_sumatra")], xs=4),
                            dbc.Col([dcc.Graph(id="crane_2_sumatra")], xs=8)
                        ]),

                        html.Br(),

                        dbc.Row([
                            dcc.Graph(id="cbu_sumatra")
                        ])
                    ], xs=5),

                    dbc.Col([
                        dbc.Row([
                            dcc.Graph(id="toh_sumatra")
                        ]),

                        html.Br(),

                        dbc.Row([
                            dcc.Graph(id="goh_sumatra")
                        ]),

                        html.Br(),

                        dbc.Row([
                            dcc.Graph(id="au_sumatra")
                        ]),
                    ], xs=4),
                    ...
                    dbc.Col([
                        dbc.CardGroup([
                            ...
                            dbc.Card(
                                html.Div(id='ConMakerShape_sumatra', style={
                                                                        "color": "white",
                                                                        "textAlign": "center",
                                                                        "fontSize": 25,
                                                                        "margin": "auto",
                                                                    }),
                                id='ConMakerCol_sumatra',
                        ...
                        dbc.CardGroup([
                            ...
                            dbc.Card(
                                html.Div(id='CraneMakerShape_sumatra', style={
                                                                        "color": "white",
                                                                        "textAlign": "center",
                                                                        "fontSize": 25,
                                                                        "margin": "auto",
                                                                    }),
                                id='CraneMakerCol_sumatra',
                                color="light", outline=True, style={"height": 55, "margin-bottom": "5px", "maxWidth": 75}
                            ),
                        ],),
                        ...
                        dbc.CardGroup([
                            ...
                            dbc.Card(
                                html.Div(id='EngMakerShape_sumatra', style={
                                                                        "color": "white",
                                                                        "textAlign": "center",
                                                                        "fontSize": 25,
                                                                        "margin": "auto",
                                                                    }),
                                id='EngMakerCol_sumatra',
                                color="light", outline=True, style={"height": 55, "margin-bottom": "5px", "maxWidth": 75}
                            ),
                        ],),
                        ...
                        dbc.CardGroup([
                            ...
                            dbc.Card(
                                html.Div(id='OthersShape_sumatra', style={
                                                                        "color": "white",
                                                                        "textAlign": "center",
                                                                        "fontSize": 25,
                                                                        "margin": "auto",
                                                                    }),
                                id='OthersCol_sumatra',
                                color="light", outline=True, style={"height": 55, "margin-bottom": "5px", "maxWidth": 75}
                            ),
                        ],),
                        ...
                        dbc.CardGroup([
                            dbc.Card(
                                dbc.CardBody(
                                    [
                                        html.P(id='NextDockingDate_sumatra',
                        ...
                        dbc.CardGroup([
                            ...
                            dbc.Card(
                                html.Div(id='ConSpareShape_sumatra', style={
                                                                        "color": "white",
                                                                        "textAlign": "center",
                                                                        "fontSize": 25,
                                                                        "margin": "auto",
                                                                    }),
                                id='ConSpareCol_sumatra',
                                color="light", outline=True, style={"height": 55, "margin-bottom": "5px", "maxWidth": 75}
                            ),
                        ],),
                        ...
                        dbc.CardGroup([
                            ...
                            dbc.Card(
                                html.Div(id='CraneSpareShape_sumatra', style={
                                                                        "color": "white",
                                                                        "textAlign": "center",
                                                                        "fontSize": 25,
                                                                        "margin": "auto",
                                                                    }),
                                id='CraneSpareCol_sumatra',
                                color="light", outline=True, style={"height": 55, "margin-bottom": "5px", "maxWidth": 75}
                            ),
                        ],),
                        ...
                        dbc.Row([
                            ...
                            dbc.CardGroup([
                                ...
                                dbc.Card(
                                    html.Div(id='CraneShape_sumatra', style={
                                                                            "color": "white",
                                                                            "textAlign": "center",
                                                                            "fontSize": 17,
                                                                            "margin": "auto",
                            ...
                            dbc.Col([
                                dbc.CardGroup([
                                    ...
                                    dbc.Card(
                                        html.Div(id='ConShape_sumatra', style={
                                                                                "color": "white",
                                                                                "textAlign": "center",
                                                                                "fontSize": 17,
                                                                                "margin": "auto",
                            ...
                            dbc.Col([
                                dbc.CardGroup([
                                    ...
                                    dbc.Card(
                                        html.Div(id='EngShape_sumatra', style={
                                                                                "color": "white",
                                                                                "textAlign": "center",
                                                                                "fontSize": 17,
                                                                                "margin": "auto",
                        ...
                        dbc.Row([
                            dbc.Col([
                                dbc.Card([
                                    dbc.CardBody([dcc.Graph(id="cs_crane_sumatra")])
                                ], color="light", outline=True, style={"height": 160, "margin-bottom": "5px"}),
                            ], xs=4, className="g-0 d-flex align-items-center"),

                            dbc.Col([
                                dbc.Card([
                                    dbc.CardBody([dcc.Graph(id="cs_conveyor_sumatra")])
                                ], color="light", outline=True, style={"height": 160, "margin-bottom": "5px"}),
                            ], xs=4, className="g-0 d-flex align-items-center"),

                            dbc.Col([
                                dbc.Card([
                                    dbc.CardBody([dcc.Graph(id="cs_engine_sumatra")])
                                ], color="light", outline=True, style={"height": 160, "margin-bottom": "5px"}),
                            ], xs=4, className="g-0 d-flex align-items-center")
                        ], className="g-0 d-flex align-items-center"),
                    ], xs=3)
...
@callback(
    [Output('hou_c1_sumatra', 'figure'),
     Output('hou_c2_sumatra', 'figure'),
     Output('toh_sumatra', 'figure'),
     Output('goh_sumatra', 'figure'),
     Output('crane_1_sumatra', 'figure'),
     Output('crane_2_sumatra', 'figure'),
     Output('cbu_sumatra', 'figure'),
     Output('au_sumatra', 'figure'),

     Output('ConMakerShape_sumatra', 'className'),
     Output('ConMakerCol_sumatra', 'className'),
     Output('CraneMakerShape_sumatra', 'className'),
     Output('CraneMakerCol_sumatra', 'className'),
     Output('EngMakerShape_sumatra', 'className'),
     Output('EngMakerCol_sumatra', 'className'),
     Output('OthersShape_sumatra', 'className'),
     Output('OthersCol_sumatra', 'className'),
     Output('NextDockingDate_sumatra', 'children'),
     Output('NextDockingCol_sumatra', 'className'),
     Output('ConSpareShape_sumatra', 'className'),
     Output('ConSpareCol_sumatra', 'className'),
     Output('CraneSpareShape_sumatra', 'className'),
     Output('CraneSpareCol_sumatra', 'className'),
     Output('CraneShape_sumatra', 'className'),
     Output('CraneCol_sumatra', 'className'),
     Output('ConShape_sumatra', 'className'),
     Output('ConCol_sumatra', 'className'),
     Output('EngShape_sumatra', 'className'),
     Output('EngCol_sumatra', 'className'),

     Output('cs_crane_sumatra', 'figure'),
     Output('cs_conveyor_sumatra', 'figure'),
     Output('cs_engine_sumatra', 'figure'),
     ],
    Input('store', 'data')
)
def update_charts(data):
    ...
    return hou_c1, hou_c2, toh, goh, crane_1, crane_2, cbu, au,\
            ...
            cs_crane, cs_conveyor, cs_engine
