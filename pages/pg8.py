...
dash.register_page(__name__, name='Celebes')
...
layout = html.Div([
                ## --ROW1--
                html.Br(),
                html.P(children=[html.Strong('Bulk Celebes')],
                       style={'textAlign': 'center', 'fontSize': 27, 'background-color':'white','color':'#2a3f5f','font-family':'Verdana'}),

                dbc.Row([
                    dbc.Col([
                        dbc.Row([
                            dbc.Col([dcc.Graph(id="hou_c1_celebes")], xs=4),
                            dbc.Col([dcc.Graph(id="crane_1_celebes")], xs=8)
                        ]),

                        html.Br(),

                        dbc.Row([
                            dbc.Col([dcc.Graph(id="hou_c2_celebes")], xs=4),
                            dbc.Col([dcc.Graph(id="crane_2_celebes")], xs=8)
                        ]),

                        html.Br(),

                        dbc.Row([
                            dcc.Graph(id="cbu_celebes")
                        ])
                    ], xs=5),

                    dbc.Col([
                        dbc.Row([
                            dcc.Graph(id="toh_celebes")
                        ]),

                        html.Br(),

                        dbc.Row([
                            dcc.Graph(id="goh_celebes")
                        ]),

                        html.Br(),

                        dbc.Row([
                            dcc.Graph(id="au_celebes")
                        ]),
                    ], xs=4),
                    ...
                    dbc.Col([
                        dbc.CardGroup([
                            ...
                            dbc.Card(
                                html.Div(id="ConMakerShape_celebes", style={
                                                                        "color": "white",
                                                                        "textAlign": "center",
                                                                        "fontSize": 25,
                                                                        "margin": "auto",
                                                                    }),
                                id="ConMakerCol_celebes",
                        ...
                        dbc.CardGroup([
                            ...
                            dbc.Card(
                                html.Div(id="CraneMakerShape_celebes", style={
                                                                        "color": "white",
                                                                        "textAlign": "center",
                                                                        "fontSize": 25,
                                                                        "margin": "auto",
                                                                    }),
                                id="CraneMakerCol_celebes",
                                color="light", outline=True, style={"height": 55, "margin-bottom": "5px", "maxWidth": 75}
                            ),
                        ],),
                        ...
                        dbc.CardGroup([
                            ...
                            dbc.Card(
                                html.Div(id="EngMakerShape_celebes", style={
                                                                        "color": "white",
                                                                        "textAlign": "center",
                                                                        "fontSize": 25,
                                                                        "margin": "auto",
                                                                    }),
                                id="EngMakerCol_celebes",
                                color="light", outline=True, style={"height": 55, "margin-bottom": "5px", "maxWidth": 75}
                            ),
                        ],),
                        ...
                        dbc.CardGroup([
                            ...
                            dbc.Card(
                                html.Div(id="OthersShape_celebes", style={
                                                                        "color": "white",
                                                                        "textAlign": "center",
                                                                        "fontSize": 25,
                                                                        "margin": "auto",
                                                                    }),
                                id="OthersCol_celebes",
                                color="light", outline=True, style={"height": 55, "margin-bottom": "5px", "maxWidth": 75}
                            ),
                        ],),
                        ...
                        dbc.CardGroup([
                            dbc.Card(
                                dbc.CardBody(
                                    [
                                        html.P(id="NextDockingDate_celebes",
                                                style={'textAlign': 'left', 
                                                    'fontSize': 15, 
                                                    'background-color':'white',
                                                    'color':'#2a3f5f',
                        ...
                        dbc.CardGroup([
                            ...
                            dbc.Card(
                                html.Div(id="ConSpareShape_celebes", style={
                                                                        "color": "white",
                                                                        "textAlign": "center",
                                                                        "fontSize": 25,
                                                                        "margin": "auto",
                                                                    }),
                                id="ConSpareCol_celebes",
                                color="light", outline=True, style={"height": 55, "margin-bottom": "5px", "maxWidth": 75}
                            ),
                        ],),
                        ...
                        dbc.CardGroup([
                            ...
                            dbc.Card(
                                html.Div(id="CraneSpareShape_celebes", style={
                                                                        "color": "white",
                                                                        "textAlign": "center",
                                                                        "fontSize": 25,
                                                                        "margin": "auto",
                                                                    }),
                                id="CraneSpareCol_celebes",
                                color="light", outline=True, style={"height": 55, "margin-bottom": "5px", "maxWidth": 75}
                            ),
                        ],),
                        ...
                        dbc.Row([
                            ...
                            dbc.CardGroup([
                                ...
                                dbc.Card(
                                    html.Div(id="CraneShape_celebes", style={
                                                                            "color": "white",
                                                                            "textAlign": "center",
                                                                            "fontSize": 17,
                                                                            "margin": "auto",
                            ...
                            dbc.Col([
                                dbc.CardGroup([
                                    ...
                                    dbc.Card(
                                        html.Div(id="ConShape_celebes", style={
                                                                                "color": "white",
                                                                                "textAlign": "center",
                                                                                "fontSize": 17,
                                                                                "margin": "auto",
                            ...
                            dbc.Col([
                                dbc.CardGroup([
                                    ...
                                    dbc.Card(
                                        html.Div(id="EngShape_celebes", style={
                                                                                "color": "white",
                                                                                "textAlign": "center",
                                                                                "fontSize": 17,
                                                                                "margin": "auto",
                        ...
                        dbc.Row([
                            dbc.Col([
                                dbc.Card([
                                    dbc.CardBody([dcc.Graph(id="cs_crane_celebes")])
                                ], color="light", outline=True, style={"height": 160, "margin-bottom": "5px"}),
                            ], xs=4, className="g-0 d-flex align-items-center"),

                            dbc.Col([
                                dbc.Card([
                                    dbc.CardBody([dcc.Graph(id="cs_conveyor_celebes")])
                                ], color="light", outline=True, style={"height": 160, "margin-bottom": "5px"}),
                            ], xs=4, className="g-0 d-flex align-items-center"),

                            dbc.Col([
                                dbc.Card([
                                    dbc.CardBody([dcc.Graph(id="cs_engine_celebes")])
                                ], color="light", outline=True, style={"height": 160, "margin-bottom": "5px"}),
                            ], xs=4, className="g-0 d-flex align-items-center")
                        ], className="g-0 d-flex align-items-center"),
                    ], xs=3)
...
@callback(
    [Output('hou_c1_celebes', 'figure'),
     Output('hou_c2_celebes', 'figure'),
     Output('toh_celebes', 'figure'),
     Output('goh_celebes', 'figure'),
     Output('crane_1_celebes', 'figure'),
     Output('crane_2_celebes', 'figure'),
     Output('cbu_celebes', 'figure'),
     Output('au_celebes', 'figure'),

     Output('ConMakerShape_celebes', 'className'),
     Output('ConMakerCol_celebes', 'className'),
     Output('CraneMakerShape_celebes', 'className'),
     Output('CraneMakerCol_celebes', 'className'),
     Output('EngMakerShape_celebes', 'className'),
     Output('EngMakerCol_celebes', 'className'),
     Output('OthersShape_celebes', 'className'),
     Output('OthersCol_celebes', 'className'),
     Output('NextDockingDate_celebes', 'children'),
     Output('NextDockingCol_celebes', 'className'),
     Output('ConSpareShape_celebes', 'className'),
     Output('ConSpareCol_celebes', 'className'),
     Output('CraneSpareShape_celebes', 'className'),
     Output('CraneSpareCol_celebes', 'className'),
     Output('CraneShape_celebes', 'className'),
     Output('CraneCol_celebes', 'className'),
     Output('ConShape_celebes', 'className'),
     Output('ConCol_celebes', 'className'),
     Output('EngShape_celebes', 'className'),
     Output('EngCol_celebes', 'className'),

     Output('cs_crane_celebes', 'figure'),
     Output('cs_conveyor_celebes', 'figure'),
     Output('cs_engine_celebes', 'figure'),
     ],
    Input('store', 'data')
)
