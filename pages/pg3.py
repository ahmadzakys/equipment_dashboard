...
layout = html.Div([
                ...
                dbc.Row([
                    dbc.Col([
                        dbc.Row([
                            dbc.Col([dcc.Graph(id="crane_1_karimun")])
                        ]),

                        html.Br(),

                        dbc.Row([
                            dbc.Col([dcc.Graph(id="crane_2_karimun")])
                        ]),

                        html.Br(),

                        dbc.Row([
                            dcc.Graph(id="cbu_karimun")
                        ])
                    ], xs=5),

                    dbc.Col([
                        dbc.Row([
                            dcc.Graph(id="toh_karimun")
                        ]),

                        html.Br(),

                        dbc.Row([
                            dcc.Graph(id="goh_karimun")
                        ]),

                        html.Br(),

                        dbc.Row([
                            dcc.Graph(id="au_karimun")
                        ]),
                    ], xs=4),
                    ...
                    dbc.Col([
                        dbc.CardGroup([
                            ...
                            dbc.Card(
                                html.Div(id="ConMakerShape_karimun", style={
                                                                        "color": "white",
                                                                        "textAlign": "center",
                                                                        "fontSize": 25,
                                                                        "margin": "auto",
                                                                    }),
                                id="ConMakerCol_karimun",
                        ...
                        dbc.CardGroup([
                            ...
                            dbc.Card(
                                html.Div(id="CraneMakerShape_karimun", style={
                                                                        "color": "white",
                                                                        "textAlign": "center",
                                                                        "fontSize": 25,
                                                                        "margin": "auto",
                                                                    }),
                                id="CraneMakerCol_karimun",
                                color="light", outline=True, style={"height": 55, "margin-bottom": "5px", "maxWidth": 75}
                            ),
                        ],),
                        ...
                        dbc.CardGroup([
                            ...
                            dbc.Card(
                                html.Div(id="EngMakerShape_karimun", style={
                                                                        "color": "white",
                                                                        "textAlign": "center",
                                                                        "fontSize": 25,
                                                                        "margin": "auto",
                                                                    }),
                                id="EngMakerCol_karimun",
                                color="light", outline=True, style={"height": 55, "margin-bottom": "5px", "maxWidth": 75}
                            ),
                        ],),
                        ...
                        dbc.CardGroup([
                            ...
                            dbc.Card(
                                html.Div(id="OthersShape_karimun", style={
                                                                        "color": "white",
                                                                        "textAlign": "center",
                                                                        "fontSize": 25,
                                                                        "margin": "auto",
                                                                    }),
                                id="OthersCol_karimun",
                                color="light", outline=True, style={"height": 55, "margin-bottom": "5px", "maxWidth": 75}
                            ),
                        ],),
                        ...
                        dbc.CardGroup([
                            dbc.Card(
                                dbc.CardBody(
                                    [
                                        html.P(id="NextDockingDate_karimun",
                                                style={'textAlign': 'left', 
                                                    'fontSize': 15, 
                                                    'background-color':'white',
                                                    'color':'#2a3f5f',
                        ...
                        dbc.CardGroup([
                            ...
                            dbc.Card(
                                html.Div(id="ConSpareShape_karimun", style={
                                                                        "color": "white",
                                                                        "textAlign": "center",
                                                                        "fontSize": 25,
                                                                        "margin": "auto",
                                                                    }),
                                id="ConSpareCol_karimun",
                                color="light", outline=True, style={"height": 55, "margin-bottom": "5px", "maxWidth": 75}
                            ),
                        ],),
                        ...
                        dbc.CardGroup([
                            ...
                            dbc.Card(
                                html.Div(id="CraneSpareShape_karimun", style={
                                                                        "color": "white",
                                                                        "textAlign": "center",
                                                                        "fontSize": 25,
                                                                        "margin": "auto",
                                                                    }),
                                id="CraneSpareCol_karimun",
                                color="light", outline=True, style={"height": 55, "margin-bottom": "5px", "maxWidth": 75}
                            ),
                        ],),
                        ...
                        dbc.Row([
                            ...
                            dbc.CardGroup([
                                ...
                                dbc.Card(
                                    html.Div(id="CraneShape_karimun", style={
                                                                            "color": "white",
                                                                            "textAlign": "center",
                                                                            "fontSize": 17,
                                                                            "margin": "auto",
                            ...
                            dbc.Col([
                                dbc.CardGroup([
                                    ...
                                    dbc.Card(
                                        html.Div(id="ConShape_karimun", style={
                                                                                "color": "white",
                                                                                "textAlign": "center",
                                                                                "fontSize": 17,
                                                                                "margin": "auto",
                            ...
                            dbc.Col([
                                dbc.CardGroup([
                                    ...
                                    dbc.Card(
                                        html.Div(id="EngShape_karimun", style={
                                                                                "color": "white",
                                                                                "textAlign": "center",
                                                                                "fontSize": 17,
                                                                                "margin": "auto",
                        ...
                        dbc.Row([
                            ...
                            dbc.Col([
                                dbc.Card([
                                    dbc.CardBody([dcc.Graph(id="cs_conveyor_karimun")])
                                ], color="light", outline=True, style={"height": 160, "margin-bottom": "5px"}),
...
@callback(
    [Output('toh_karimun', 'figure'),
     Output('goh_karimun', 'figure'),
     Output('crane_1_karimun', 'figure'),
     Output('crane_2_karimun', 'figure'),
     Output('cbu_karimun', 'figure'),
     Output('au_karimun', 'figure'),

     Output('ConMakerShape_karimun', 'className'),
     Output('ConMakerCol_karimun', 'className'),
     Output('CraneMakerShape_karimun', 'className'),
     Output('CraneMakerCol_karimun', 'className'),
     Output('EngMakerShape_karimun', 'className'),
     Output('EngMakerCol_karimun', 'className'),
     Output('OthersShape_karimun', 'className'),
     Output('OthersCol_karimun', 'className'),
     Output('NextDockingDate_karimun', 'children'),
     Output('NextDockingCol_karimun', 'className'),
     Output('ConSpareShape_karimun', 'className'),
     Output('ConSpareCol_karimun', 'className'),
     Output('CraneSpareShape_karimun', 'className'),
     Output('CraneSpareCol_karimun', 'className'),
     Output('CraneShape_karimun', 'className'),
     Output('CraneCol_karimun', 'className'),
     Output('ConShape_karimun', 'className'),
     Output('ConCol_karimun', 'className'),
     Output('EngShape_karimun', 'className'),
     Output('EngCol_karimun', 'className'),

     Output('cs_conveyor_karimun', 'figure'),
     ],
    Input('store', 'data')
)
