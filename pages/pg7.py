...
layout = html.Div([
                ...
                dbc.Row([
                    dbc.Col([
                        dbc.Row([
                            dbc.Col([dcc.Graph(id="hou_c1_borneo")], xs=4),
                            dbc.Col([dcc.Graph(id="crane_1_borneo")], xs=8)
                        ]),

                        html.Br(),

                        dbc.Row([
                            dbc.Col([dcc.Graph(id="hou_c2_borneo")], xs=4),
                            dbc.Col([dcc.Graph(id="crane_2_borneo")], xs=8)
                        ]),

                        html.Br(),

                        dbc.Row([
                            dcc.Graph(id="cbu_borneo")
                        ])
                    ], xs=5),

                    dbc.Col([
                        dbc.Row([
                            dcc.Graph(id="toh_borneo")
                        ]),

                        html.Br(),

                        dbc.Row([
                            dcc.Graph(id="goh_borneo")
                        ]),

                        html.Br(),

                        dbc.Row([
                            dcc.Graph(id="au_borneo")
                        ]),
                    ], xs=4),
                    ...
                    dbc.Col([
                        dbc.CardGroup([
                            ...
                            dbc.Card(
                                html.Div(id="ConMakerShape_borneo", style={
                                                                        "color": "white",
                                                                        "textAlign": "center",
                                                                        "fontSize": 25,
                                                                        "margin": "auto",
                                                                    }),
                                id="ConMakerCol_borneo",
                        ...
                        dbc.CardGroup([
                            ...
                            dbc.Card(
                                html.Div(id="CraneMakerShape_borneo", style={
                                                                        "color": "white",
                                                                        "textAlign": "center",
                                                                        "fontSize": 25,
                                                                        "margin": "auto",
                                                                    }),
                                id="CraneMakerCol_borneo",
                                color="light", outline=True, style={"height": 55, "margin-bottom": "5px", "maxWidth": 75}
                            ),
                        ],),
                        ...
                        dbc.CardGroup([
                            ...
                            dbc.Card(
                                html.Div(id="EngMakerShape_borneo", style={
                                                                        "color": "white",
                                                                        "textAlign": "center",
                                                                        "fontSize": 25,
                                                                        "margin": "auto",
                                                                    }),
                                id="EngMakerCol_borneo",
                                color="light", outline=True, style={"height": 55, "margin-bottom": "5px", "maxWidth": 75}
                            ),
                        ],),
                        ...
                        dbc.CardGroup([
                            ...
                            dbc.Card(
                                html.Div(id="OthersShape_borneo", style={
                                                                        "color": "white",
                                                                        "textAlign": "center",
                                                                        "fontSize": 25,
                                                                        "margin": "auto",
                        ...
                        dbc.CardGroup([
                            dbc.Card(
                                dbc.CardBody(
                                    [
                                        html.P(id="NextDockingDate_borneo",
                                                style={'textAlign': 'left', 
                                                    'fontSize': 15, 
                                                    'background-color':'white',
                                                    'color':'#2a3f5f',
                        ...
                        dbc.CardGroup([
                            ...
                            dbc.Card(
                                html.Div(id="ConSpareShape_borneo", style={
                                                                        "color": "white",
                                                                        "textAlign": "center",
                                                                        "fontSize": 25,
                                                                        "margin": "auto",
                                                                    }),
                                id="ConSpareCol_borneo",
                                color="light", outline=True, style={"height": 55, "margin-bottom": "5px", "maxWidth": 75}
                            ),
                        ],),
                        ...
                        dbc.CardGroup([
                            ...
                            dbc.Card(
                                html.Div(id="CraneSpareShape_borneo", style={
                                                                        "color": "white",
                                                                        "textAlign": "center",
                                                                        "fontSize": 25,
                                                                        "margin": "auto",
                                                                    }),
                                id="CraneSpareCol_borneo",
                                color="light", outline=True, style={"height": 55, "margin-bottom": "5px", "maxWidth": 75}
                            ),
                        ],),
                        ...
                        dbc.Row([
                            ...
                            dbc.CardGroup([
                                ...
                                dbc.Card(
                                    html.Div(id="CraneShape_borneo", style={
                                                                            "color": "white",
                                                                            "textAlign": "center",
                                                                            "fontSize": 17,
                                                                            "margin": "auto",
                            ...
                            dbc.Col([
                                dbc.CardGroup([
                                    ...
                                    dbc.Card(
                                        html.Div(id="ConShape_borneo", style={
                                                                                "color": "white",
                                                                                "textAlign": "center",
                                                                                "fontSize": 17,
                                                                                "margin": "auto",
                            ...
                            dbc.Col([
                                dbc.CardGroup([
                                    ...
                                    dbc.Card(
                                        html.Div(id="EngShape_borneo", style={
                                                                                "color": "white",
                                                                                "textAlign": "center",
                                                                                "fontSize": 17,
                                                                                "margin": "auto",
                        ...
                        dbc.Row([
                            dbc.Col([
                                dbc.Card([
                                    dbc.CardBody([dcc.Graph(id="cs_crane_borneo")])
                                ], color="light", outline=True, style={"height": 160, "margin-bottom": "5px"}),
                            ], xs=4, className="g-0 d-flex align-items-center"),

                            dbc.Col([
                                dbc.Card([
                                    dbc.CardBody([dcc.Graph(id="cs_conveyor_borneo")])
                                ], color="light", outline=True, style={"height": 160, "margin-bottom": "5px"}),
                            ], xs=4, className="g-0 d-flex align-items-center"),

                            dbc.Col([
                                dbc.Card([
                                    dbc.CardBody([dcc.Graph(id="cs_engine_borneo")])
                                ], color="light", outline=True, style={"height": 160, "margin-bottom": "5px"}),
                            ], xs=4, className="g-0 d-flex align-items-center")
                        ], className="g-0 d-flex align-items-center"),
                    ], xs=3)
...
@callback(
    [Output('hou_c1_borneo', 'figure'),
     Output('hou_c2_borneo', 'figure'),
     Output('toh_borneo', 'figure'),
     Output('goh_borneo', 'figure'),
     Output('crane_1_borneo', 'figure'),
     Output('crane_2_borneo', 'figure'),
     Output('cbu_borneo', 'figure'),
     Output('au_borneo', 'figure'),

     Output('ConMakerShape_borneo', 'className'),
     Output('ConMakerCol_borneo', 'className'),
     Output('CraneMakerShape_borneo', 'className'),
     Output('CraneMakerCol_borneo', 'className'),
     Output('EngMakerShape_borneo', 'className'),
     Output('EngMakerCol_borneo', 'className'),
     Output('OthersShape_borneo', 'className'),
     Output('OthersCol_borneo', 'className'),
     Output('NextDockingDate_borneo', 'children'),
     Output('NextDockingCol_borneo', 'className'),
     Output('ConSpareShape_borneo', 'className'),
     Output('ConSpareCol_borneo', 'className'),
     Output('CraneSpareShape_borneo', 'className'),
     Output('CraneSpareCol_borneo', 'className'),
     Output('CraneShape_borneo', 'className'),
     Output('CraneCol_borneo', 'className'),
     Output('ConShape_borneo', 'className'),
     Output('ConCol_borneo', 'className'),
     Output('EngShape_borneo', 'className'),
     Output('EngCol_borneo', 'className'),

     Output('cs_crane_borneo', 'figure'),
     Output('cs_conveyor_borneo', 'figure'),
     Output('cs_engine_borneo', 'figure'),
     ],
    Input('store', 'data')
)
